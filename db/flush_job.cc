...
extern uint64_t max_l0_files;
extern uint64_t current_l0_files;
extern uint64_t scheduled_compactions;
...
Status FlushJob::WriteLevel0Table() {
  current_l0_files = cfd_->current()->storage_info()->NumLevelFiles(0);
  if(current_l0_files>max_l0_files){
